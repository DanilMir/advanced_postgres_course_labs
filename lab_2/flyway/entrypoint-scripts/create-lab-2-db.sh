...
psql -v ON_ERROR_STOP=1 --username "postgres" --dbname "postgres" <<-EOSQL
    ...
    REVOKE ALL ON DATABASE lab_2 FROM PUBLIC;
    
    -- create admin role
    CREATE ROLE admin;
    GRANT ALL PRIVILEGES ON DATABASE lab_2 TO admin;
    
    -- create readonly role
    CREATE ROLE readonly;
    GRANT CONNECT ON DATABASE lab_2 TO readonly;
    
    -- create readwrite role
    CREATE ROLE readwrite;
    GRANT CONNECT ON DATABASE lab_2 TO readwrite;
